"""Page/tab pool with state tracking.

Ported from Scrapling's ``engines/_browsers/_page.py``.
"""

from dataclasses import dataclass
from threading import RLock
from typing import Generic, List, Literal, Optional, TypeVar, cast, overload
...
class PageInfo(Generic[PageType]):
    ...
    def __eq__(self, other_page):
        """Compare this page to another page object."""
